...
hl.bind(mainMod .. " + " .. "M", hl.dsp.exec_cmd("wlogout -b 4 -m 260"))

hl.bind(mainMod .. " + " .. "E", hl.dsp.exec_cmd("dolphin --platformtheme qt6ct"))
...
hl.bind(mainMod .. " + " .. "D", hl.dsp.exec_cmd("wofi --hide-scroll --insensitive --no-actions --prompt \"Looking for something, Niko?\" --show drun"))
...
hl.bind(mainMod .. " + " .. "R", hl.dsp.exec_cmd("~/.config/hypr/scripts/repaper.sh"))

-- reload waybar

hl.bind(mainMod .. " + " .. "B", hl.dsp.exec_cmd("~/.config/hypr/scripts/rebar.sh"))
